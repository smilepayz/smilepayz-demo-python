...
from v2.mexico.bean.OrderStatusInquiry import OrderStatusInquiry
...
def status_inquiry(env,merchant_id,merchant_secret,private_key,trade_type,trade_no,order_no):
    ...
    assert result.get('paymentMethod') == 'SPEI', f"支付方式错误，paymentMethod={result.get('paymentMethod')}"
...
if __name__ == '__main__':
    ...
    trade_type = "1"
    trade_no = "1412015825061712394817447"
    order_no = ""
