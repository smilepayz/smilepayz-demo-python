...
def checkSha256RsaSignature(content, signature, publicKeyStr):
    try:
        ...
        print("error:" + str(e))  # 将异常对象转换为字符串后打印
        return False
...
signature = sha256RsaSignature(private_key_str, string_to_sign)
print("signature", signature)

check_result = checkSha256RsaSignature(string_to_sign, signature, publicKeyStr)
